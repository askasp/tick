...
- Change the files. Don't commit, push or switch branches: the pipeline does that.
- Keep the change small and focused on the task, and match the code around it.
